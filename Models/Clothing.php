...
class Clothing extends Product
{
    ...
    public function __construct(Int $code, String $name, String $genre, Int $price, String $description, String $image, String $kind_animal, String $material, String $size, String $type,String $period_avaible_start,String $period_avaible_end, String $color)
    {
